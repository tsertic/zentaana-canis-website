    ...
    <footer className="bg-primary-900 text-neutral-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-accent text-sm text-neutral-400 tracking-[0.3em] uppercase">
                  FCI 19/25
                </p>
              </div>
            </div>
          ...
          <div>
            <p className="font-display text-sm uppercase tracking-widest text-accent-500 mb-6">
              {t("nav.home")}
            </p>
        ...
        <div className="border-t border-neutral-800 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-neutral-500">
            &copy; {year} Zentaana Canis. {t("footer.rights")}.
          </p>
          <p className="text-xs text-neutral-500">{t("footer.fci")}</p>
        </div>
      </div>
    </footer>
  );
